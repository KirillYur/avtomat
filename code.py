...
if 0<nub<=0.04:
 ...
 A1_004 = -4e-8*kb**6+3e-5*kb**5-0.0001*kb**4+0.0018*kb**3-0.0105*kb**2+0.0754*kb+5.6671
 A1_01 = 1e-7*kb**6 - 8e-6*kb**5 + 0.0002*x**4 - 0.0036*kb**3 + 0.0269*kb**2 - 0.0349*kb + 5.3714
 A_2 = A1_01 + delta_a2*(A1_004-A1_01)
elif 0.1<nub<0.2
 delta_a3 = (nub-0.1)/0.1
 A1_02 = -4e8*kb**6 + 3e-6*kb**5 - 0.0001*kb**4 + 0.0018*kb**3 - 0.0105*kb**2 + 0.0754*kb + 5.6671
 A1_01 = 1e-7*kb**6 - 8e-6*kb**5 + 0.0002*x**4 - 0.0036*kb**3 + 0.0269*kb**2 - 0.0349*kb + 5.3714
 A_3 = A1_02 + delta_a3*(A1_01-A1_02)

elif 0.2<nub<0.3
 delta_a4 = (nub-0.04)/0.06
 A1_02 = -4e8*kb**6 + 3e-6*kb**5 - 0.0001*kb**4 + 0.0018*kb**3 - 0.0105*kb**2 + 0.0754*kb + 5.6671
 A1_03 = 1e-6*kb**6 - 6e-5*kb**5 + 0.0014*kb**4 - 0.0167*kb**3 + 0.0953*kb**2 - 0.1395*kb+ 4.8747
 A_4 = A1_004 + delta_a4*(A1_0-A1_004)
